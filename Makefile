SERVICE = pranjan77contigfilterset2
SERVICE_CAPS = pranjan77contigfilterset2
SPEC_FILE = pranjan77contigfilterset2.spec
URL = https://kbase.us/services/pranjan77contigfilterset2
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
